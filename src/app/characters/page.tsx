            ...
            <main className='py-6 first:mt-0'>
                <section className='px-10 py-10 border-[#463614] text-white border-2 m-20 bg-gray-950 bg-opacity-60 backdrop-blur-md'>
                    ...
                    <div className='flex mt-10'>
                        <div className='mt-5'>
                            <h1 className='text-6xl text-white'>Ranni the Witch</h1>
                            <p className='mt-5 mb-3 text-base italic'>Also known as Lunar Princess Ranni</p>
                            <Image
                                className='border-2 border-[#c49634]'
                                width={600}
                                height={200}
                        ...
                        <div id='quote' className='mt-32 w-[40%] ml-16 border-box text-xl'>
                            <p className='mt-5'>Ranni the Witch is one of the Demigods, and the focus of one of the games most elaborate questlines.</p>
